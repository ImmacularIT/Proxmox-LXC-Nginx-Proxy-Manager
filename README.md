...
A Proxmox VE LXC adaptation of the [Nginx Proxy Manager](https://github.com/NginxProxyManager/nginx-proxy-manager), maintained by [ImmacularIT](https://github.com/ImmacularIT).
